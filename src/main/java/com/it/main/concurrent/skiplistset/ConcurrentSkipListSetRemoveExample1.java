...
public class ConcurrentSkipListSetRemoveExample1 {

	/*
	 * The java.util.concurrent.ConcurrentSkipListSet.remove() method is an in-built
	 * function in Java which is used to remove an element if it is present in this
	 * set.
	 */
