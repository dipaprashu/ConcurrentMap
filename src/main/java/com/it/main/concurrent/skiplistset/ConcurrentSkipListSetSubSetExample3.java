...
public class ConcurrentSkipListSetSubSetExample3 {

	/*
	 * The function returns a view of the portion of this set whose elements range
	...
	public static void main(String[] args) {
		...
		NavigableSet<Integer> subSet = set.subSet(2, true, 8, true);

		// Printing the elements of the descending set
		System.out.println("Contents of the subset: " + subSet);
	}
